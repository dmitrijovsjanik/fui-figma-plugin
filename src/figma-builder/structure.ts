...
const SEMANTIC_TOKENS: Record<SemanticSection, Record<string, SemRef>> = {
  ...
  border: {
    // Static (no hover) — subtle decorative outlines, separators
    'neutral': 'gray.a6',
    'accent': 'accent.a6',
    'success': 'green.a6',
    'warning': 'amber.a6',
    'danger': 'red.a6',
    'info': 'blue.a6',
    // Default + hover — interactive borders (inputs, buttons)
    'neutral-strong': 'gray.a7',
    'neutral-strong-hover': 'gray.a8',
    'accent-strong': 'accent.a7',
    'accent-strong-hover': 'accent.a8',
    'success-strong': 'green.a7',
    'success-strong-hover': 'green.a8',
    'warning-strong': 'amber.a7',
    'warning-strong-hover': 'amber.a8',
    'danger-strong': 'red.a7',
    'danger-strong-hover': 'red.a8',
    'info-strong': 'blue.a7',
    'info-strong-hover': 'blue.a8',
  },
  ring: {
    'focus': 'accent.a8',
    'focus-error': 'red.a8',
